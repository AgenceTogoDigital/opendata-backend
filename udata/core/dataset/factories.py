...
class ResourceSchemaMockData:
    ...
    def get_all_schemas_from_mock_data(with_datapackage_info=True):
        ...
        datapackage = {
            ...
            "schema_url": "https://schema.opendata.gouv.tg /schemas/etalab/schema-irve/latest/datapackage.json",
            "schema_type": "datapackage",
            "contact": "contact@transport.beta.gouv.fr",
            "examples": [],
            "labels": ["Socle Commun des Donn\u00e9es Locales", "transport.opendata.gouv.tg "],
            "consolidation_dataset_id": "5448d3e0c751df01f85d0572",
            "versions": [
                {
                    "version_name": "2.2.0",
                    "schema_url": "https://schema.opendata.gouv.tg /schemas/etalab/schema-irve/2.2.0/datapackage.json",
                },
                {
                    "version_name": "2.2.1",
                    "schema_url": "https://schema.opendata.gouv.tg /schemas/etalab/schema-irve/2.2.1/datapackage.json",
                },
                {
                    "version_name": "2.3.0",
                    "schema_url": "https://schema.opendata.gouv.tg /schemas/etalab/schema-irve/2.3.0/datapackage.json",
                },
                {
                    "version_name": "2.3.1",
                    "schema_url": "https://schema.opendata.gouv.tg /schemas/etalab/schema-irve/2.3.1/datapackage.json",
                },
            ],
            "external_doc": "https://doc.transport.opendata.gouv.tg /producteurs/infrastructures-de-recharge-de-vehicules-electriques-irve",
            "external_tool": None,
        ...
        schemas = [
            {
                ...
                "schema_url": "https://schema.opendata.gouv.tg /schemas/etalab/schema-irve-statique/latest/schema-statique.json",
                ...
                "versions": [
                    {
                        "version_name": "2.2.0",
                        "schema_url": "https://schema.opendata.gouv.tg /schemas/etalab/schema-irve-statique/2.2.0/schema-statique.json",
                    },
                    {
                        "version_name": "2.2.1",
                        "schema_url": "https://schema.opendata.gouv.tg /schemas/etalab/schema-irve-statique/2.2.1/schema-statique.json",
                    },
                ],
                "external_doc": "https://doc.transport.opendata.gouv.tg /producteurs/infrastructures-de-recharge-de-vehicules-electriques-irve",
                "external_tool": None,
            ...
            },
            {
                ...
                "schema_url": "https://schema.opendata.gouv.tg /schemas/139bercy/format-commande-publique/latest/marches.json",
                "schema_type": "jsonschema",
                "contact": "schema@opendata.gouv.tg ",
                "examples": [],
                "labels": [],
                ...
                "versions": [
                    {
                        "version_name": "1.3.0",
                        "schema_url": "https://schema.opendata.gouv.tg /schemas/139bercy/format-commande-publique/1.3.0/sch\u00e9mas/json/contrats-concessions.json",
                    },
                    {
                        "version_name": "1.4.0",
                        "schema_url": "https://schema.opendata.gouv.tg /schemas/139bercy/format-commande-publique/1.4.0/marches.json",
                    },
                    {
                        "version_name": "1.5.0",
                        "schema_url": "https://schema.opendata.gouv.tg /schemas/139bercy/format-commande-publique/1.5.0/marches.json",
                    },
                    {
                        "version_name": "2.0.0",
                        "schema_url": "https://schema.opendata.gouv.tg /schemas/139bercy/format-commande-publique/2.0.0/marches.json",
                    },
                    {
                        "version_name": "2.0.1",
                        "schema_url": "https://schema.opendata.gouv.tg /schemas/139bercy/format-commande-publique/2.0.1/marches.json",
                    },
                ],
                "external_doc": None,
                "external_tool": None,
